...
const sampleData = {
  part_b: {
    ...
    table2: {
      ...
      researchPapers: [
        {
          title:
            "Deep Learning Based Image Classification for Medical Diagnosis",
      ...
      ictInnovations: [
        {
          ...
          description:
            "Developed a comprehensive platform for conducting secure online exams",
          year: "2024",
        ...
        },
        {
          ...
          description:
            "Predictive analytics system for early identification of at-risk students",
          year: "2023",
  ...
  part_a: {
    ...
    personal_in: {
      address:
        "Plot No. 45, Sector 7, Nerul, Navi Mumbai, Maharashtra - 400706",
...
async function addSampleData() {
  try {
    ...
    const q = query(
      usersRef,
      where("email", "==", "d2022.darshan.khapekar@ves.ac.in"),
    );
    ...
    console.log(
      `   • Academic Qualifications: ${sampleData.part_a.academic_qualifications.length}`,
    );
    console.log(
      `   • Research Degrees: ${sampleData.part_a.research_degrees.length}`,
    );
    console.log(
      `   • Prior Appointments: ${sampleData.part_a.employment.prior.length}`,
    );
    console.log(
      `   • Current Posts: ${sampleData.part_a.employment.posts.length}`,
    );
    console.log(
      `   • Research Papers: ${sampleData.part_b.table2.researchPapers.length}`,
    );
    console.log(
      `   • Publications: ${sampleData.part_b.table2.publications.length}`,
    );
    console.log(
      `   • Patents & Awards: ${sampleData.part_b.patents_policy_awards.length}`,
    );
    console.log(
      `   • Invited Lectures: ${sampleData.part_b.invited_lectures.length}`,
    );
    console.log(
      `   • Research Projects: ${sampleData.part_b.table2.researchProjects.length}`,
    );
    console.log(
      `   • Consultancy Projects: ${sampleData.part_b.table2.consultancyProjects.length}`,
    );
    console.log(
      `   • ICT Innovations: ${sampleData.part_b.table2.ictInnovations.length}`,
    );
    console.log(
      `   • Research Guidance: ${sampleData.part_b.table2.researchGuidance.length}`,
    );
    console.log(`   • FDP/Courses: ${sampleData.part_a.courses_fdp.length}`);
    console.log(
      `   • Teaching Activities: ${sampleData.part_a.teaching_student_assessment.teaching.length}`,
    );
    console.log(
      `   • Other Activities: ${sampleData.part_a.teaching_student_assessment.activities.length}`,
    );

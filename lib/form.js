const formSchema = {
  ...
  sections: [
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          columns: [
            ...
            },
            {
              ...
              label:
                "Essential Qualifications for the Post at the time of Appointment",
              type: "text",
              required: true,
            },
            {
              ...
              label:
                "Nature of Appointment (Regular/ Fixed term/ Temporary/ Adhoc)",
              type: "select",
        ...
        },
        {
          id: "hrd_courses",
          title:
            "Human Resource Development Center Orientation / Refresher Course / FDP/ MOOC/ One-Two week Course attended so far",
          type: "table",
          allowMultiple: true,
          columns: [
            {
      ...
      subsections: [
        {
          id: "table1",
          title:
            "Table 1: Assessment Criteria and Methodology for University/College Teachers",
          tables: [
            {
              ...
              rows: [
                {
                  ...
                  description:
                    "(Teaching: Blackboard Teaching: ICT based Practical /Laboratory Tutorials /Assignments / Project, Field Work Group Discussion, Seminars Remedial! Teaching, Clarifying doubts within and outside the class hours Additional teaching to Support counseling and mentoring)",
                  unit: "% of Teaching",
                  grading_criteria: {
                    good: "80% & Above",
            ...
            },
            {
              ...
              rows: [
                {
                  ...
                  activity:
                    "Administrative responsibilities such has Head, Chairperson /Dean/Director / IQAC Coordinator/different committees/Warden, etc.",
                  fields: [
                    {
                      id: "total_days_spent",
                ...
                },
                {
                  ...
                  activity:
                    "Examination and evaluation duties assigned by the college/ university or attending the examination paper evaluation",
                  subactivities: [
                ...
                },
                {
                  ...
                  activity:
                    "Institutional! Governance/ Participation in State/Central bodies/Committee on education, Research and National development etc.(Govt. Nominee/Nodal officer/Enquiry committee member/inspection committee member/state Govt. Workshop committee/Govt. CAS Committee/Subject expect/",
                  fields: [
                    {
                      id: "total_days_spent",
                      label: "Total days Spent per year",
                ...
                },
                {
                  ...
                  activity:
                    "Organizing seminars/ conferences/workshops, etc. and other college/university Activities",
                  fields: [
                    {
                      id: "total_days_spent",
                      label: "Total days Spent per year",
              ...
              overall_grading: {
                ...
                satisfactory:
                  "Satisfactory in teaching and good or satisfactory in activity At S.No.2",
                not_satisfactory:
                  "If neither good nor satisfactory in overall grading",
              },
        ...
        },
        {
          id: "table2",
          title:
            "Table 2: Methodology for Institute Teachers for calculating Academic / Research Score",
          description:
            "(Assessment must be based on evidence produced by the teacher such as: copy of publications, project sanction letter, utilization and completion certificates issued by the University and acknowledgements/or patent filing and approval letters, students' Ph.D. award letter, etc.)",
          ...
          categories: [
            {
              ...
              columns: [
                ...
                },
                {
                  id: "journal_details",
                  label:
                    "Journal Name, Page nos., Vol. no., Issue no., Year of publication",
                  type: "text",
                  required: true,
                },
                {
            ...
            },
            {
              ...
              title:
                "(2) Publications (other than Research papers) (Books, Chapters in Books)",
              subcategories: [
                {
                  id: "books_published",
                  title: "(2)(a)(I) Books Published with ISSN/ ISBN number",
                  scoring:
                    "International Publisher: 12 points per Book for Single Author; National Publisher: 10 points per Book for Single Author, etc. as per Appendix II Table 2 (GR: 8/3/19)",
                  type: "repeatable_table",
                  allowMultiple: true,
                  columns: [
                    {
                ...
                },
                {
                  ...
                  scoring:
                    "Editor of Book by international Publisher: 10 points per Book for Single Author; Editor of Book by National Publisher: 8 points per Book for Single Author",
                  type: "repeatable_table",
                  allowMultiple: true,
                  columns: [
                    {
                ...
                },
                {
                  ...
                  title:
                    "(2)(b) Translation works in Indian and Foreign Languages by qualified faculties",
                  ...
                  columns: [
                    ...
                    },
                    {
                      id: "original_title",
                      label:
                        "Original Title of Chapter or Research paper / Book with Page Nos. ISSN / ISBN NO.",
                      type: "text",
                      required: true,
                    },
                    {
                    ...
                    },
                    {
                      id: "translated_title",
                      label:
                        "Translated Title of Chapter or Research paper /Book with Page Nos. ISSN / ISBN NO.",
                      type: "text",
                      required: true,
                    },
                    {
              ...
              subcategories: [
                {
                  ...
                  columns: [
                    ...
                    },
                    {
                      id: "ict_resources",
                      label:
                        "Specify ICT's resources: web link: YouTube Videos-Audios / Smart Classroom/ Simulation Games/ Blogging/ Online Discussion Forums / Virtual Laboratories / Telecast / Picture/ Models /Charts if any",
                      type: "textarea",
                    },
                    {
                      id: "date_approval",
                ...
                },
                {
                  ...
                  columns: [
                    ...
                    },
                    {
                      id: "ict_resources",
                      label:
                        "Specify ICTs resources: web link / Youtube link: Audio Video/ Telecast / Picture/ Models / Charts if any",
                      type: "textarea",
                    },
                    {
                      id: "date_approval",
                ...
                },
                {
                  ...
                  subsubcategories: [
                    {
                      id: "moocs_complete",
                      title:
                        "(3)(c)(i) Development of complete MOOCs in 4 quadrants (4 credit course)",
                      scoring:
                        "20 per curricula /Course (In case of MOOCs of lesser credits 05 marks/credit)",
                      type: "repeatable_table",
                      allowMultiple: true,
                      columns: [
                        {
                        ...
                        },
                        {
                          id: "programme_name",
                          label:
                            "Name of Programme where curricular introduced",
                          type: "text",
                          required: true,
                        },
                        {
                    ...
                    },
                    {
                      id: "moocs_module",
                      title:
                        "(3)(c)(ii) MOOCs (developed in 4 quadrant) per module/ lecture",
                      ...
                      columns: [
                        ...
                        },
                        {
                          ...
                          label:
                            "Name of Programme & Course where curricula introduced",
                          type: "text",
                          required: true,
                        },
                        {
                    ...
                    },
                    {
                      ...
                      title:
                        "(3)(c)(iii) Content writer/ subject matter expert for each module of MOOCs (at least one quadrant)",
                      ...
                      columns: [
                        ...
                        },
                        {
                          id: "programme_course_name",
                          label:
                            "Name of Programme & Course where Content is introduced",
                          type: "text",
                          required: true,
                        },
                        {
                        ...
                        },
                        {
                          id: "ict_resources",
                          label:
                            "Specify ICTs resources: web link/ Youtube link: Audio Video/ Telecast/",
                          type: "textarea",
                        },
                        {
                          id: "date_approval",
                    ...
                    },
                    {
                      ...
                      title:
                        "(3)(c)(iv) Course Coordinator for MOOCs (4 credit course)",
                      scoring:
                        "8 Points per curricula / Course (In case of MOOCs of lesser credits 02 marks / credit)",
                      type: "repeatable_table",
                      allowMultiple: true,
                      columns: [
                        {
                  ...
                  grandTotal: {
                    label:
                      "Total(3)(c): (3)(c)(i)+(3)(c)(ii)+(3)(c)(iii)+(3)(c)(iv)",
                    sumColumns: ["self_appraisal_score", "api_score_verified"],
                  },
                },
                {
                  ...
                  subsubcategories: [
                    {
                      ...
                      title:
                        "(3)(d)(i) Development of e-Content in 4 quadrants for a complete course/e-book",
                      ...
                      columns: [
                        ...
                        },
                        {
                          id: "title_econtent",
                          label:
                            "Title of e-Content course/ e-book with no. of pages",
                          type: "text",
                          required: true,
                        },
                        {
                          id: "programme_course",
                          label:
                            "Name of Programme & Course to which Introduced",
                          type: "text",
                          required: true,
                        },
                        {
                    ...
                    },
                    {
                      id: "econtent_module",
                      title:
                        "(3)(d)(ii) e-Content (developed in 4 quadrants per module / Course)",
                      ...
                      columns: [
                        ...
                        },
                        {
                          id: "title_econtent",
                          label:
                            "Title of e content / e-module with no. of pages, ISSN/ISBN No. If any",
                          type: "text",
                          required: true,
                        },
                        {
                    ...
                    },
                    {
                      ...
                      title:
                        "(3)(d)(iii) Contribution to development of e-Content module in complete course / paper / e–book (At least one quadrant)",
                    ...
                    },
                    {
                      id: "econtent_editor",
                      title:
                        "(3)(d)(iv) Editor of e-content for complete course/paper/e-book",
                      ...
                      columns: [
                        ...
                        },
                        {
                          id: "title_econtent",
                          label:
                            "Title of e-Content Course with no. of pages, ISSN/ ISBN NO. If any",
                          type: "text",
                          required: true,
                        },
                        {
                  ...
                  grandTotal: {
                    label:
                      "Total(3)(d): (3)(d)(i)+(3)(d)(ii)+(3)(d)(iii)+(3)(d)(iv)",
                    sumColumns: ["self_appraisal_score", "api_score_verified"],
                  },
                },
              ],
              ...
              subcategories: [
                {
                  ...
                  scoring:
                    "Ph.D.: 10 points degree awarded & 05 per thesis submitted; M.Phil./P.G dissertation: 2 points per degree rewarded",
                  type: "repeatable_table",
                  allowMultiple: true,
                  rows: [
                    {
                ...
                },
                {
                  ...
                  scoring:
                    "A: More than 10 lakhs (10 points per Project); B: Less than 10 lakhs (5 points per Project)",
                  type: "repeatable_table",
                  allowMultiple: true,
                  columns: [
                    {
                ...
                },
                {
                  ...
                  scoring:
                    "A: More than 10 lakhs (5 points per Project); B: Less than 10 lakhs (2 points per Project)",
                  type: "repeatable_table",
                  allowMultiple: true,
                  columns: [
                    {
              ...
              subcategories: [
                {
                  ...
                  title: "(5)(a) Patents",
                  scoring:
                    "10 points per International Patent and 7 points per National Patent",
                  type: "repeatable_table",
                  allowMultiple: true,
                  columns: [
                    {
                ...
                },
                {
                  ...
                  scoring:
                    "A: International (10 points per Policy Document); B: National (7 points per Policy Document); C: State (4 points per Policy Document)",
                ...
                },
                {
                  ...
                  scoring:
                    "A: International (7 points per Awards/Fellowship); B: National (5 points per Awards/Fellowship)",
                  type: "repeatable_table",
                  allowMultiple: true,
                  columns: [
                    {
            ...
            },
            {
              id: "invited_lectures",
              title:
                "(6) Invited lectures /Resource Person /paper presentation in Seminars /Conferences/full paper in Conference Proceedings",
              ...
              scoring:
                "International (Abroad): 7 points per Seminars /Conferences; International (within Country): 5 points per Seminars/Conferences; National: 3 points per Seminars /Conferences; State/University Level: 2 points per Seminars/Conferences",
              type: "repeatable_table",
              allowMultiple: true,
              columns: [
                {
                ...
                },
                {
                  ...
                  label:
                    "Mode of Presentation: Invited lectures / Resource Person / Paper presentation",
                  type: "select",
                  options: [
                    "Invited lectures",
                    "Resource Person",
                ...
                },
                {
                  id: "conference_level",
                  label:
                    "Whether International (Abroad)/ International (within Country) /National /State / University Level",
                  type: "select",
                  options: [
          ...
          scoringNotes: [
            ...
            },
            {
              ...
              content:
                "Paper presented if part of edited book or proceeding then it can be claimed only once. For joint supervision of research students, the formula shall be 70% of the total score for Supervisor and Co-supervisor. Supervisor and Co-supervisor, both shall get 7 marks each.",
            },
            {
          ...
          summaryTable: {
            ...
            rows: [
              ...
              },
              {
                ...
                label:
                  "(4) Research guidance / Projects Completed / Projects Ongoing /Consultancy",
                fields: [
                  {
                    id: "self_appraisal_score",
                    label: "Self-Appraisal Score",
    ...
    },
    {
      ...
      description:
        "(Please attach copies of certificates and/or letters sanction orders, papers etc. wherever Necessary)",
      field: {
        id: "enclosures_list",
        type: "textarea",
        rows: 10,
  ...
  undertakings: {
    title: "UNDERTAKING",
    content:
      "I Dr /Mr./Mrs.....................Under takes that the information provided is correct as per Institute Records and documents submitted by me to Proforma enclosed along with the duly filled in _____________ PBAS",
    signatures: [
      {
    ...
    finalNote:
      "N.B.: The individual PBAS Performa duly filled along with all enclosures, submitted for CAS promotions will be verified by the institutes as necessary and placed before the Screening Cum Evaluation Committee or Selection Committee for Assessment Verification",
  },
  validation: {
    ...
    scoringRules: {
      ...
      upperCapping:
        "Categories 5(b) and 6 combined cannot exceed 30% of total research score",
      minimumCategories:
        "Score must come from minimum 3 out of 6 categories in Table 2",
    },
  },
};

...
export default function ReportsPage() {
  ...
  const fetchReportData = async () => {
    try {
      ...
      const { data: appraisals, error: appraisalsError } =
      ...
      const scoresWithAnalysis =
        appraisals?.filter((a) => a.llm_analysis?.overall_score) || [];
      const averageScore =
        scoresWithAnalysis.length > 0
          ? scoresWithAnalysis.reduce(
              (sum, a) => sum + a.llm_analysis.overall_score,
              0,
            ) / scoresWithAnalysis.length
          : 0;
    ...
    return (
      ...
      >
        <div className="w-full max-w-4xl px-6 space-y-6">
          ...
          <div
            className="rounded-2xl p-6 h-48 skeleton-shimmer"
      ...
      >
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Comprehensive insights into faculty appraisal data
          </p>
        </div>
          ...
          <TabsContent value="departments" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Appraisal statistics by department
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {dept.count} appraisals
                        </p>
                      </div>
                      <div className="text-right">
                        <Badge
                          variant={
                            dept.averageScore >= 85 ? "default" : "secondary"
                          }
                        >
                          {dept.averageScore > 0
                            ? `${Math.round(dept.averageScore)}/100`
                            : "No scores"}
                        </Badge>
                      </div>
                    </motion.div>
          ...
          <TabsContent value="trends" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Appraisal trends over academic years
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {stats.yearlyTrends.map((trend, index) => (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {trend.count} appraisals
                        </p>
                      </div>
                      <div className="text-right">
                        <Badge variant="outline">
                          {trend.averageScore}/100
                        </Badge>
                      </div>
                    </motion.div>
                  ))}
          ...
          <TabsContent value="status" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current status of all appraisals
                </CardDescription>
              </CardHeader>
              <CardContent>
